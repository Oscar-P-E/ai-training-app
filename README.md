...
This app was built using the T3 Stack, which is a full stack framework for building web apps. It was built using React, TypeScript, Next.js, Clerk, Prisma, Tailwind CSS, tRPC, Axiom, and deployed on Vercel.